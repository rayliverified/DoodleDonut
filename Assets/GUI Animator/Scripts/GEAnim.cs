...
using UnityEngine.UI;		// If you have found error at this line on Unity 5.x, please make sure that you are using Unity 5.x with a valid license.
...
public class GEAnim : GUIAnim
{
	...
	public override void Anim_In_Move()
	{
		...
		float time = (float)m_MoveIn.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_MoveIn.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_MoveVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_RotationIn.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_RotationIn.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_ScaleIn.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_ScaleIn.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_FadeIn.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_FadeIn.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_FadeVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_MoveOut.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_MoveOut.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_MoveVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_RotationOut.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_RotationOut.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_RotationVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_ScaleOut.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_ScaleOut.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_ScaleVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_FadeOut.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		float delay = (float)m_FadeOut.Delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_FadeVariable = 0.0f;
			// DOTween: https://www.assetstore.unity3d.com/en/#!/content/27676
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_ScaleLoop.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
	...
	{
#if DOTWEEN || HOTWEEN || ITWEEN || LEANTWEEN
		float time = (float)m_FadeLoop.Time/(float)GEAnimSystem.Instance.m_GUISpeed;
		delay = (float)delay/(float)GEAnimSystem.Instance.m_GUISpeed;
#endif
#if DOTWEEN
			m_FadeVariable = 0.0f;
